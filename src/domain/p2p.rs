...
pub fn verify_dispatch_signature(
    ...
    let signature_bytes = STANDARD
        ...
        .map_err(|e| format!("invalid dispatch signature base64: {e}"))?;
    let signature = Signature::from_slice(&signature_bytes)
        .map_err(|e| format!("invalid dispatch signature bytes: {e}"))?;
    ...
    verifying_key
        ...
        .map_err(|_| "dispatch signature verification failed".to_string())
}
